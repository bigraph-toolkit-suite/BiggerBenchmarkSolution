...
// Generated from "./foo/ruleset.grg" on Wed May 28 22:04:16 CEST 2025
...
namespace de.unika.ipd.grGen.Action_ruleset
{
	...
	public class Rule_nextRule : GRGEN_LGSP.LGSPRulePattern
	{
		...
		public void Modify(GRGEN_LGSP.LGSPActionExecutionEnvironment actionEnv, GRGEN_LIBGR.IMatch _curMatch)
		{
			...
			GRGEN_MODEL.@append node_v6_1a40720 = GRGEN_MODEL.@append.CreateNode(graph);
			GRGEN_MODEL.@BPort node_v6_1a40720_p0 = GRGEN_MODEL.@BPort.CreateNode(graph);
			GRGEN_MODEL.@thisRef node_v5_972c544 = GRGEN_MODEL.@thisRef.CreateNode(graph);
			GRGEN_MODEL.@BPort node_v5_972c544_p0 = GRGEN_MODEL.@BPort.CreateNode(graph);
			GRGEN_MODEL.@BEdge node_e1_2d85799 = GRGEN_MODEL.@BEdge.CreateNode(graph);
			graph.SettingAddedEdgeNames( nextRule_addedEdgeNames );
			GRGEN_MODEL.@bPrnt edge__edge2 = GRGEN_MODEL.@bPrnt.CreateEdge(graph, node_v6_1a40720, node_r1);
			GRGEN_MODEL.@bNode edge_c9 = GRGEN_MODEL.@bNode.CreateEdge(graph, node_v6_1a40720_p0, node_v6_1a40720);
			GRGEN_MODEL.@bPrnt edge__edge3 = GRGEN_MODEL.@bPrnt.CreateEdge(graph, node_v5, node_v6_1a40720);
			GRGEN_MODEL.@bPrnt edge__edge4 = GRGEN_MODEL.@bPrnt.CreateEdge(graph, node_v5_972c544, node_v4);
			GRGEN_MODEL.@bNode edge_c10 = GRGEN_MODEL.@bNode.CreateEdge(graph, node_v5_972c544_p0, node_v5_972c544);
			GRGEN_MODEL.@bLink edge__edge5 = GRGEN_MODEL.@bLink.CreateEdge(graph, node_v6_1a40720_p0, node_e0);
			GRGEN_MODEL.@bLink edge__edge6 = GRGEN_MODEL.@bLink.CreateEdge(graph, node_v1_p0, node_e0);
			GRGEN_MODEL.@bLink edge__edge7 = GRGEN_MODEL.@bLink.CreateEdge(graph, node_v5_p0, node_e1_2d85799);
			GRGEN_MODEL.@bLink edge__edge8 = GRGEN_MODEL.@bLink.CreateEdge(graph, node_v5_972c544_p0, node_e1_2d85799);
			{ // eval_0
		...
		private static string[] nextRule_addedNodeNames = new string[] { "v6_1a40720", "v6_1a40720_p0", "v5_972c544", "v5_972c544_p0", "e1_2d85799" };
	...
	public class Rule_appendRule : GRGEN_LGSP.LGSPRulePattern
	{
		...
		public void Modify(GRGEN_LGSP.LGSPActionExecutionEnvironment actionEnv, GRGEN_LIBGR.IMatch _curMatch)
		{
			...
			GRGEN_MODEL.@Cell node_v4_9456169 = GRGEN_MODEL.@Cell.CreateNode(graph);
			GRGEN_MODEL.@Void node_v7_d7cd185 = GRGEN_MODEL.@Void.CreateNode(graph);
			GRGEN_MODEL.@next node_v3_d381999 = GRGEN_MODEL.@next.CreateNode(graph);
			GRGEN_MODEL.@this node_v5_8ed2367 = GRGEN_MODEL.@this.CreateNode(graph);
			graph.SettingAddedEdgeNames( appendRule_addedEdgeNames );
			GRGEN_MODEL.@bPrnt edge__edge2 = GRGEN_MODEL.@bPrnt.CreateEdge(graph, node_v5, node_v4_9456169);
			GRGEN_MODEL.@bPrnt edge__edge3 = GRGEN_MODEL.@bPrnt.CreateEdge(graph, node_v7_d7cd185, node_r1);
			GRGEN_MODEL.@bPrnt edge__edge4 = GRGEN_MODEL.@bPrnt.CreateEdge(graph, node_v3_d381999, node_v0);
			GRGEN_MODEL.@bPrnt edge__edge5 = GRGEN_MODEL.@bPrnt.CreateEdge(graph, node_v4_9456169, node_v3_d381999);
			GRGEN_MODEL.@bPrnt edge__edge6 = GRGEN_MODEL.@bPrnt.CreateEdge(graph, node_v5_8ed2367, node_v4_9456169);
			{ // eval_0
				Dictionary<GRGEN_LIBGR.INode, GRGEN_LIBGR.SetValueType> var_nodesWithSites = (Dictionary<GRGEN_LIBGR.INode, GRGEN_LIBGR.SetValueType>)(GRGEN_LIBGR.ContainerHelper.Domain(var_indexMap));
				foreach(KeyValuePair<GRGEN_LIBGR.INode, GRGEN_LIBGR.SetValueType> entry_0 in var_nodesWithSites)
				{
		...
		private static string[] appendRule_addedNodeNames = new string[] { "v4_9456169", "v7_d7cd185", "v3_d381999", "v5_8ed2367" };
